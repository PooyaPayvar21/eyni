    ...
    <div className="container mx-auto px-4 py-10">
      <div className="mx-auto max-w-7xl">
        ...
        <p className="text-muted-foreground mt-1">
          پزشک مورد نظر خود را جستجو یا بر اساس شهر فیلتر کنید.
        </p>
        ...
        >
          ...
          <button
            type="submit"
            className="rounded-lg bg-primary px-4 py-2.5 text-primary-foreground font-medium hover:bg-primary/90"
          >
            جستجو
          </button>
        </form>

        <div className="mt-8 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          {doctors.map((doc) => (
            <Link
              key={doc.id}
              href={`/doctors/${doc.slug}`}
              className="group rounded-2xl p-[1px] bg-gradient-to-br from-cyan-500/30 to-sky-500/30 hover:from-cyan-500/50 hover:to-sky-500/50 transition"
            >
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="mt-4 inline-flex items-center text-sm font-medium text-primary">
                      مشاهده پروفایل <ArrowRight className="mr-1 h-4 w-4" />
                    </div>
                  </div>
                </div>
              </div>
