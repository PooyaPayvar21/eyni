  ...
  return (
    <div className="min-h-[calc(100vh-56px)]">
      ...
      <section className="relative overflow-hidden">
        ...
        <svg
          aria-hidden
          className="absolute -left-20 -top-20 h-[40rem] w-[40rem] opacity-20 blur-3xl dark:opacity-25 pointer-events-none"
          viewBox="0 0 200 200"
        >
          <defs>
        ...
        <div className="container mx-auto px-4 py-12 sm:py-16 lg:py-20 relative">
          <div className="mx-auto max-w-2xl md:max-w-3xl lg:max-w-4xl text-center md:text-left">
            ...
            <h1 className="mt-3 text-black text-3xl sm:text-4xl lg:text-5xl font-extrabold leading-tight tracking-tight bg-gradient-to-br from-slate-900 via-slate-700 to-slate-900 dark:from-slate-100 dark:via-slate-300 dark:to-slate-100 bg-clip-text dark:text-white ">
              رزرو نوبت پزشکی با پزشکان معتبر در سراسر ایران
            </h1>
            <p className="mt-4 text-muted-foreground text-base sm:text-lg max-w-2xl md:max-w-3xl">
              پزشک خود را بر اساس شهر و کلینیک پیدا کنید، ظرفیت‌ لحظه‌ای را
              ببینید و در چند ثانیه نوبت بگیرید — بدون نیاز به حساب کاربری.
              به‌زودی پرداخت آنلاین با زرین‌پال.
            </p>
            ...
            {/* Quick search panel */}
            <div className="mt-6 rounded-2xl border border-[#AEDCEA] bg-card p-4 sm:p-5 shadow-sm">
              <form
                action="/doctors"
                method="get"
                className="grid grid-cols-1 md:grid-cols-3 gap-3"
              >
                <div className="flex items-center gap-2 rounded-lg border border-[#AEDCEA] px-3 py-2 bg-background">
                ...
                <button
                  type="submit"
                  className="cursor-pointer border border-[#AEDCEA] inline-flex items-center justify-center rounded-lg bg-primary px-4 py-2.5 text-primary-foreground font-medium hover:bg-primary/90 hover:scale-105 hover:bg-[#AEE5F4] transition-all transform-0.1"
                >
                  جستجو
                </button>
              </form>
      ...
      <section className="container mx-auto px-4 py-10 sm:py-14">
        <div className="mx-auto max-w-7xl grid gap-4 sm:gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
          <div className="rounded-2xl p-[1px] bg-gradient-to-br from-cyan-500/30 to-sky-500/30 hover:shadow-sm cursor-pointer">
            <div className="rounded-2xl p-5 transition-shadow bg-card">
              ...
              <p className="text-sm text-muted-foreground mt-2">
                فقط نام و شماره تماس را وارد کنید و فوری نوبت بگیرید.
              </p>
            </div>
          </div>
          <div className="rounded-2xl p-[1px] bg-gradient-to-br from-cyan-500/30 to-sky-500/30 hover:shadow-sm cursor-pointer">
            <div className="rounded-2xl p-5 transition-shadow bg-card">
              ...
              <p className="text-sm text-muted-foreground mt-2">
                زمان‌های خالی بلافاصله رزرو می‌شوند تا دو بار رزرو نشود.
              </p>
            </div>
          </div>
          <div className="rounded-2xl p-[1px] bg-gradient-to-br from-cyan-500/30 to-sky-500/30 hover:shadow-sm cursor-pointer">
            <div className="rounded-2xl p-5 transition-shadow bg-card">
              ...
              <p className="text-sm text-muted-foreground mt-2">
                هر پزشک صفحه اختصاصی برای دیده‌شدن در موتورهای جستجو دارد.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-7xl flex items-end justify-between mb-6 px-1">
          <div>
            <h2 className="text-2xl sm:text-3xl font-bold">
              پزشکان پربازدید و پُر نوبت
            </h2>
            <p className="text-muted-foreground mt-1">
              بر اساس تعداد نوبت‌های اخیر.
            </p>
          </div>
          <Link
            href="/doctors"
